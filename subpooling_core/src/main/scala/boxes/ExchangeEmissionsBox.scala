...
import contracts.emissions.{EmissionsContract, ExchangeContract}
 ...
 */
class ExchangeEmissionsBox(box: InputBox, emissionsContract: ExchangeContract){
  val asInput: InputBox = box
  val contract: ExchangeContract = emissionsContract
