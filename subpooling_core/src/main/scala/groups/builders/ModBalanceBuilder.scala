...
import contracts.holding.{AdditiveHoldingContract, HoldingContract, SimpleHoldingContract, TokenHoldingContract}
import global.AppParameters.NodeWallet
import global.Helpers
import groups.entities.Pool
import groups.models.{GroupBuilder, TransactionStage}

import org.ergoplatform.appkit.{Address, BlockchainContext, InputBox}
import org.slf4j.{Logger, LoggerFactory}

class ModBalanceBuilder(rewardPaid: Long, holdingContract: HoldingContract, baseFeeMap: Map[Address, Long], rootStage: TransactionStage[InputBox],
